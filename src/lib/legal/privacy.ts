        ...
        },
        {
          ...
          items: {
            es: [
              ...
              "Archivos de evidencia: los documentos que la organización sube al vault (políticas, registros, informes de sus proveedores). Se guardan tal cual, junto a su huella SHA-256, su nombre original y quién los subió. Attesta no abre esos archivos ni analiza su contenido: solo los custodia y demuestra que no han cambiado.",
            ...
            en: [
              ...
              "Evidence files: the documents the organization uploads to the vault (policies, logs, vendor reports). They are stored as they are, together with their SHA-256 fingerprint, original filename and who uploaded them. Attesta does not open these files or analyse their content: it only holds them and demonstrates that they have not changed.",
