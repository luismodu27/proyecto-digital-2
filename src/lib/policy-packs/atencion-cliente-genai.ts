...
export const ATENCION_CLIENTE_GENAI_PACK_EN: PolicyPack = {
  ...
  controls: [
    ...
    },
    {
      ...
      article: "Art. 5.1.f (scope) + Annex III.1.c + GDPR Art. 9",
      severity: "alta",
      conditional:
    ...
    },
    {
      ...
      article: "Art. 50.1 (provider; deployer verifies)",
      severity: "alta",
      conditional:
    ...
    },
    {
      id: "transparencia-emociones-biometrica",
      title:
        "Emotion-recognition / biometric-categorization information",
      description:
        "The deployer's OWN duty (applicable from 2 Aug 2026): if you expose customers to an emotion-recognition or biometric-categorization system, you must inform them of its operation (Art. 50.3), in addition to complying with the GDPR (biometric data = special category, Art. 9). Remember that such a system, although not prohibited for customers, is high-risk under Annex III (see the emotions triage). Evidence = operation notice given to the exposed customers and a documented GDPR legal basis.",
      article: "Art. 50.3 (deployer) + GDPR Art. 9",
      severity: "media",
      conditional:
        "Applicable from 2 Aug 2026. Only if you use emotion recognition or biometric categorization.",
    },
    {
      id: "info-chatbot-rgpd",
    ...
    {
      id: "minimizacion",
      title: "Data minimization in the conversation (GDPR)",
      description:
        "Limit the data the chatbot collects and retains to what is necessary for the purpose (GDPR Art. 5.1.c): avoid requesting or storing more personal data than needed, and define a limited retention of transcripts. Evidence = collection/retention configuration and a minimization policy applied to the chatbot.",
    ...
    },
    {
      ...
      description:
        "Marking the generated output (text, image, audio, video) in a machine-readable format detectable as artificial is an obligation of the PROVIDER of the generative system (Art. 50.2), not yours as deployer. Your control = require the provider to embed that interoperable mark/watermark in its output and keep it as evidence; it also helps you meet your own Art. 50.4 labeling. Evidence = provider confirmation that it marks the content (technical documentation / contractual clause).",
      article: "Art. 50.2 (provider; deployer requires)",
      severity: "media",
    ...
    },
    {
      ...
      article:
        "Good practice (consumer protection); not a high-risk obligation under the AI Act",
      severity: "media",
    },
    {
      id: "conservacion-evidencia",
      ...
      description:
        "Keep a record of the governance decisions and of the transparency evidence: what AI content was labeled and how, the active chatbot notices, the classification triage note, the training (Art. 4) and the clauses required from the provider. It serves to demonstrate accountability (GDPR Art. 5.2) and to prove Art. 50 transparency before an authority. Evidence = file with the notices, labeling, triage and provider documentation, dated.",
      article: "GDPR Art. 5.2 (accountability)",
      severity: "media",
    },
  ],
};
